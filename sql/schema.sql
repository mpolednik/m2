...
# Database: maturita
# Generation Time: 2013-03-03 14:22:29 +0000
# ************************************************************
...
CREATE TABLE `image` (
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `image_ibfk_1` FOREIGN KEY (`id_category`) REFERENCES `category` (`id`) ON DELETE CASCADE,
  CONSTRAINT `image_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
